describe('User can see list of Curriculumvitae', () => {
    ...
    it('displays first curriculumvitae', () => {
      cy.get('#curriculumvitae-1').within(() => {
        cy.get('.ui.header').should('contain', 'Full Stack programmering, Craft Academy, Stockholm');
    ...
    it('displays second curriculumvitae', () => {
        cy.get('#curriculumvitae-2').within(() => {
          cy.get('.ui.header').should('contain', 'Worked as an Head chef in Stockholm based hotels.');
      ...
      it('displays third curriculumvitae', () => {
        cy.get('#curriculumvitae-3').within(() => {
          cy.get('.ui.header').should('contain', 'Worked as Head chef in 5 star hotels in India.');
      ...
      it('displays fourth curriculumvitae', () => {
        cy.get('#curriculumvitae-4').within(() => {
          cy.get('.ui.header').should('contain', 'Worked as Sous.chef in India serving variuos Head of states');
      ...
      it('displays sixth curriculumvitae', () => {
        cy.get('#curriculumvitae-6').within(() => {
          cy.get('.ui.header').should('contain', 'Bsc.Hotel and Hospitality Management');
